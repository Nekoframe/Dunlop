...
<body>
	...
	<!-- header_image -->
	<section class="header_image dat_product_banner">
	...
	<section class="main_wrapper">
		...
		<?php 
			$subpage = 'link';
			include('dat_aside.php'); 
		?>

		<div class="main_area dat_product_listing_wrapper">
			...
			<content>
				...
				<div class="product_detail_wrapper dat_product_detail">
					<div class="row">
								...
								<div class="feature_section">
									...
									<div class="row">
										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature1.png" alt="Feature 1" title="Feature 1">
										</div>

										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature2.png" alt="Feature 2" title="Feature 2">
										</div>

										<div class="col-xl-3 col-lg-3  col-sm-3 col-3 feature">
											<img src="images/products/dat_feature3.png" alt="Feature 3" title="Feature 3">
										</div>

										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature4.png" alt="Feature 4" title="Feature 4">
										</div>

										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature5.png" alt="Feature 5" title="Feature 5">
										</div>

										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature6.png" alt="Feature 6" title="Feature 6">
										</div>

										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature7.png" alt="Feature 7" title="Feature 7">
										</div>
										
										<div class="col-xl-3 col-lg-3 col-sm-3 col-3 feature">
											<img src="images/products/dat_feature8.png" alt="Feature 8" title="Feature 8">
										</div>
									</div>
								</div>
